...
import (
	...
	assets "ubiqnet/assets"
	oldcmds "ubiqnet/commands"
	core "ubiqnet/core"
	"ubiqnet/core/commands"
	"ubiqnet/core/node"
...
`,
	...
	Run: func(req *cmds.Request, res cmds.ResponseEmitter, env cmds.Environment) error {
		...
		conf.Miner.DepositGas = 7000000
		conf.Miner.HarvestGas = 7000000
		conf.Miner.DebugApi = ":8070"
...
func doInit(out io.Writer, repoRoot string, empty bool, confProfiles string, conf *config.Config) error {
	if _, err := fmt.Fprintf(out, "initializing UBIQNET node at %s\n", repoRoot); err != nil {
		return err
	}
	fmt.Println(repoRoot)
	// fmt.Println("Please input wallet password")
	// var password string
	...
	minerNode := node.MinerNode{}
	minerNode.CreateMinerWallet(repoRoot)
