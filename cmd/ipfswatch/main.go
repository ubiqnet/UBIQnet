...
var http = flag.Bool("http", false, "expose UBIQNET HTTP API")
var repoPath = flag.String("repo", os.Getenv("UBIQNET_PATH"), "UBIQNET_PATH to use")
...
func main() {
	...
	// precedence
	// 1. --repo flag
	// 2. UBIQNET_PATH environment variable
	// 3. default repo path
	var ipfsPath string
	if *repoPath != "" {
		ipfsPath = *repoPath
