...
import (
	...
	repo "ubiqnet/repo"
	"ubiqnet/repo/common"
	dir "ubiqnet/thirdparty/dir"

	filestore "github.com/ipfs/go-filestore"
	keystore "github.com/ipfs/go-ipfs-keystore"

	config "ubiqnet/config"
	serialize "ubiqnet/config/serialize"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://ubiqnet/blob/master/docs/datastores.md#flatfs.")
	}
...
// https://ubiqnet/issues/8088 for more details).
...
func (r *FSRepo) SwarmKey() ([]byte, error) {
	...
	if err != nil {
		if os.IsNotExist(err) {
			err = nil
			return []byte(constants.SwarmKey), nil
		}
		return nil, err
	}
	defer f.Close()
